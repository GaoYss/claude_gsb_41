...
// New 构造维修状态查询模块, 依赖路灯 / 故障 / 维修 / 材料模块的只读能力。
func New(db *gorm.DB, lamps *lamp.Repository, faults *fault.Repository, repairs *repair.Repository, materials *material.Service) *Module {
